package com.manager.phanquyenchucnang.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("phanquyenchucnang");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("phanquyenchucnang");
        ...
        config.getMapConfigs().put("com.manager.phanquyenchucnang.domain.*", initializeDomainMapConfig(jHipsterProperties));
